...
export function LazyBuildForm({code,initial,canCompose=false}:{code:string;initial?:BuildPreset;canCompose?:boolean}){return <BuildForm code={code} initial={initial} canCompose={canCompose}/>}
